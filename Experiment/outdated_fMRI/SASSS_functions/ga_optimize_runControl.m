...
GA.cbalColinPowerWeights = [1 0 0 0];	% 1 = cbal, 2 = eff, 3 = hrf shape, 4 = freq
...
GA.numGenerations = 40; 
	% how many iterations of the GA to run.
GA.sizeGenerations = 50;  
...
GA.maxFreqDevthresh = .1;   % maximum acceptable deviation from input frequencies (GA.freqConditions)
...
for nm = 1:nmodels
   ...
   eval(['save ../shooter_stim/model' num2str(nm) '_' M.date ' M'])
   save GAworkspace
   diary off
   fprintf('\n')
end
