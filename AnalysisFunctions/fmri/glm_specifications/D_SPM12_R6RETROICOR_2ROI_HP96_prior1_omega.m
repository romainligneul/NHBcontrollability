...
% variations
clear all;
F.name = 'SPM12_R6RETROICOR_2ROI_HP96_prior1_bis'; % name of the GLM - first level
...
% %        
        n=n+1;
        pmod(1).name{n} = 'std_omegaPE';
        pmod(1).param{n} = zscore(std_omegaPE'); %zscore(std_SSpe'-std_SASpe');
        pmod(1).poly{n} = 1;
%         
        n=n+1;
